...
def consolidated_dedup_menu():
    ...
    menu_context = {
        "Purpose": "Comprehensive de-duplication using multiple advanced methods and algorithms",
        ...
        "Key Features": [
            ...
            "📊 Analysis & Reports - Comprehensive duplicate analysis and reporting",
            "⚙️ Settings & Configuration - Configure thresholds and algorithms",
        ],
        "Tips": [
            ...
            "ImageDedup Pro offers professional-grade features",
