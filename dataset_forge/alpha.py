...
def find_alpha_channels(hq_folder, lq_folder):
    return AlphaAnalyzer.find_alpha_channels(hq_folder, lq_folder)
    ...
    for filename in tqdm(alpha_results["hq_alpha"], desc="Processing HQ Images"):
        ...
        try:
            ...
            if success:
                ...
                errors.append(f"Failed to process HQ: {filename} ({msg})")
        except Exception as e:
    ...
    for filename in tqdm(alpha_results["lq_alpha"], desc="Processing LQ Images"):
        ...
        try:
            ...
            if success:
                ...
                errors.append(f"Failed to process LQ: {filename} ({msg})")
        except Exception as e:
